...
function Homepage(){
    ...
    useEffect(()=>{
        const response = [{id: 1, price: 20, model: "mi chaussettes", brand: "KINDY"},{id: 2, price: 20, model: "mi chaussettes", brand: "KINDY"},{id: 3, price: 20, model: "mi chaussettes", brand: "KINDY"}]
                    ...
                    <div className={`${style.items} d-flex justify-content-center align-items-center`}>
                        {
                            !productList.length ? (
                                ...
                                productList.map((p)=>(
                                    <div key={p.id} className={`${style.item} d-flex justify-content-center align-items-center`}><Product product={p}/></div>
                                ))
                            )
                        }
                    </div>
